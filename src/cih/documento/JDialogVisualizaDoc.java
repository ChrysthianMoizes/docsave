...
public class JDialogVisualizaDoc extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogVisualizaDoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogVisualizaDoc dialog = new JDialogVisualizaDoc(new javax.swing.JFrame(), true);
